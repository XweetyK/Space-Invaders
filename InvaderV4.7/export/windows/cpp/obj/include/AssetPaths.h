...
class HXCPP_CLASS_ATTRIBUTES AssetPaths_obj : public hx::Object
{
	...
	public:
		...
		static ::String barricade__png;
		static ::String disp__png;
		static ::String images_go_here__txt;
		static ::String ovni__png;
		static ::String PlayerNave__png;
		static ::String SpriteBala__png;
		static ::String SpriteNave__png;
